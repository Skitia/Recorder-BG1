...
CHAIN IF ~IsGabber("X3Rec")RandomNum(5,1)~ THEN X3RFER r1
@7
EXIT 

CHAIN IF ~IsGabber("X3Rec")RandomNum(5,2)~ THEN X3RFER r2
@8 
EXIT 

CHAIN IF ~IsGabber("X3Rec")RandomNum(5,3)~ THEN X3RFER r3
@9
EXIT 

CHAIN IF ~IsGabber("X3Rec")RandomNum(5,4)~ THEN X3RFer r4
@10
DO ~RunAwayFromNoLeaveArea(LastTalkedToBy,10)~ EXIT 

CHAIN IF ~IsGabber("X3Rec")RandomNum(5,5)~ THEN X3RFER r5
@11
EXIT 
...
CHAIN IF ~!IsGabber("X3Rec")!IsGabber(Player1)~ THEN X3RFER flee 
@23
DO ~MoveToObject("X3Rec")~ EXIT 
