...
== BALORA ~*puff, puff.* How do you play this thing?~
== X3RecB ~Alora! That's precious.~
== BALORA ~Oh, I was going to give it back. I just wanted to play it, you make such pretty sounds from it.~
...
== BALORA ~Oh. Okay. *Puff* I think I did it.~ 
...
== BBranw ~What is your curiosity, gnome?~
== X3RecB ~Have you ever been afraid, to...kill someone?~
== BBranw ~To be killed, yes, but to kill? There is no room for that kind of fear.~
= ~Why do you ask?~
== X3RecB ~Sometimes we're not killing monsters, just other people, and I get...really disturbed by it.~
== BBranw ~An honorable battle should be remembered. Give it time, girl. You will get used to it.~
EXIT 
...
CombatCounter(0)
!See([ENEMY])
Global("X3RecCoran","GLOBAL",0)~ THEN BCORAN X3RecCoran1
...
CombatCounter(0)
!See([ENEMY])
Global("X3RecDorn","GLOBAL",0)~ THEN BDORN X3RecDorn1
...
== BDORN ~That you know I was speaking of you only proves my point.~
== X3RecB ~There's more to strength than might and brawn.~
== BDORN ~There may be. But that you lack as well.~
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("X3RecDynaheir","GLOBAL",0)~ THEN BDynah X3RecDynaheir1
...
== BDynah ~Thy could be a competent mage, if you wished to specialize.~
== X3RecB ~I could, but I do so love the arts. I don't think I could ever abandon it and be happy with myself.~
== BDynah ~I understand thee. Pursue what brings thee joy and happiness.~ 
EXIT 
...
== BEDWIN ~I've no interest in answering your petty questions, gnome. (Nor would you have the capacity to even understand).~
== X3RecB ~I'm sorry. I didn't know it was personal.~
== BEDWIN ~And now you are mocking me?! Shoo!~
...
CombatCounter(0)
!See([ENEMY])
Global("X3RecEldoth","GLOBAL",0)~ THEN BELDOT X3RecEldoth1
...
== BELDOT ~You are merely homegrown, taught by a wandering tutor. Your education is less supreme.~
== X3RecB ~Um well...maybe...~
== BELDOT ~You should go home, find yourself a husband, and keep to your place.~
== X3RecB ~My...my place? You are just being cruel. I thought you were a bard I could admire, but you are so selfish.~
== BELDOT ~You have much to learn, girl. The world is not all pleasant. It exists to be manipulated.~
...
CombatCounter(0)
!See([ENEMY]) 
Global("X3RecFaldorn","GLOBAL",0)~ THEN BFALDO X3RecFaldorn1
~What is that creature that rides on your shoulder, gnome?~
DO ~SetGlobal("X3RecEldoth","GLOBAL",1)~
== X3RecB ~Gustav? He's a ferret. He's beautiful, isn't he?~
== BFALDO ~I appreciate your love and devotion to the creatures of the forest.~
== BFALDO ~But he should be wild and free, not your toy.~
== X3RecB ~We give each other care and affection. He is more than just a plaything to me. He is my friend.~
== BFALDO ~And he belongs in the forest.~ 
...
== BGARRI ~'...from your heart to mine.'~
== X3RecB ~Oh my. It's fun to have another bard that knows your verses.~
== BGARRI ~Where did you pick up the song?~
...
== BGARRI ~Good that he did. Love and music makes the world bright and joyous.~
...
== BIMOEN ~Oh, it's all right, Recorder. I thought you were one of those serious booksies until I heard you perform in Winthrop's inn.~
== X3RecB ~I *am* a serious "booksie". But I do love to sing and dance and play.~
== BIMOEN ~I was spinning and trying to mimic one of your dances one night. Ol' Winthrop was just watching and laughing.~
== X3RecB ~I'd love to teach you, Imoen, if you like. Just ask.~
== BIMOEN ~Thanks. I might just do that sometime.~ 
EXIT 
...
== BJAHEI ~You should be more careful with your pet. This is not the place for your little friend.~
== X3RecB ~He and I may be little...but we keep each other safe. He does like to zoom away sometimes.~
== BJAHEI ~But your ferret zooming off and you running after him endangers yourself. You could get into a trap, or worse.~
== X3RecB ~I'm sorry...I'll be more careful.~
== BJAHEI ~That is all I ask dear. You are too smart to make such mistakes.~
EXIT 
...
CombatCounter(0)
!See([ENEMY])
Global("X3RecKagain","GLOBAL",0)~ THEN BKAGAI X3RecKagain1
...
== BKAGAI ~Yer cutting yourself, short. Ye need a partner to help with the business side of things.~
...
== BKAGAI ~If you were willing to change that, you'd find that a bucket load of gold coins would suit anyone very fast.~
EXIT 
...
== BKHALI ~Y-yes. Have you v-visited?.~ 
== X3RecB ~No. But I have heard stories about their performances and artists.~
== BKHALI ~I d-do miss it sometimes.~
== X3RecB ~Would you ever go back?~
== BKHALI ~I...c-can't say. I have not t-thought about it.~
...
== BKHALI ~I w-would like that sometime, Recorder. T-thank you.~ 
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("X3RecKivan","GLOBAL",0)~ THEN BKIVAN X3RecKivan1
...
== BKIVAN ~She was my love. And then she was taken from me.~
== X3RecB ~Who...who was responsible?~
== BKIVAN ~Tazok. And I will have my revenge.~
== X3RecB ~I don't know what to say.~
== BKIVAN ~And for your sake, I hope you never have to.~
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("X3RecMinsc","GLOBAL",0)~ THEN BMINSC X3RecMinsc1
...
== BMINSC ~Look at how his eyes watch my hamster. Like the fox watching the duck.~
== X3RecB ~I'm sorry. I'll put him in my pack so he can't leap out if he's bothering you.~
== BMINSC ~No! Minsc would talk to Gustav first, and ensure he means well.~
== X3RecB ~Um...okay...~
== BMINSC ~Now weasel. Boo and I know you like to eat. But no eating my hamster. Do this and Boo might share some of his chestnuts.~
== X3RecB ~I don't think...~
== BMINSC ~Ah, he nods in understanding. Minsc is sure all will be well!~
...
== BMONTA ~That's a nice little critter you have there.~
== X3RecB ~Oh, thank you. Gustav and I are the best of friends~
== BMONTA ~I heard ferret tastes a bit like venison. One good yank of its neck and we could have a decent meal.~
== X3RecB ~We are not eating my ferret! Please, give us some space.~
== BMONTA ~How your eyeballs lit up in fear! Fear not...for now. Maybe if I am hungry later.~
== X3RecB ~Just go away!~
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("X3RecNeera","GLOBAL",0)~ THEN BNEERA X3RecNeera1
...
== BNEERA ~Or you know. He might turn into a squirrel.~
== X3RecB ~That'd be only...temporary, right?~
== BNEERA ~I don't know. He could also just get burned by a sudden fireball?~
...
CombatCounter(0)
!See([ENEMY])
Global("X3RecQuayle","GLOBAL",0)~ THEN BQUAYL X3RecQuayle1
...
== BQUAYL ~Nonsense! Ask me anything, and my big brain will provide.~
...
== BQUAYL ~Ah...um...you know, I'll get back to you on that.~
...
== BRASAAD ~There is much meditating and honing of the body and self. Serenity is an art that takes time to master, focus, and calm.~
== X3RecB ~It sounds so peaceful...I would like a bit of that serenity now.~
== BRASAAD ~Does something trouble you, my friend?~
== X3RecB ~N-no. It's just...um...well, never mind.~
== BRASAAD ~It is not wise to hoard your demons to fester. I am here to speak when you need me, Recorder.~
...
CombatCounter(0)
!See([ENEMY])
Global("X3RecSafana","GLOBAL",0)~ THEN BSAFAN X3RecSafana1
...
== BSAFAN ~You could be my little project. We just need to put that charm to use.~
== X3RecB ~Um, excuse me?~
== BSAFAN ~As long as you stay away from my game, the wealth you would come to collect would all be yours.~
== X3RecB ~I um, thank you for your earlier compliment, but that's just not me.~
== BSAFAN ~Your loss, darling.~ 
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("X3RecSharTeel","GLOBAL",0)~ THEN BSHART X3RecSharteel1
...
== BSHART ~Grow up. You are being used. Stop being so docile.~
...
CombatCounter(0)
!See([ENEMY])
Global("X3RecSkie","GLOBAL",0)~ THEN BSKIE X3RecSkie1
...
== BSKIE ~Ooh, where did you buy it from? I would love to have some of it.~ 
== X3RecB ~Here, have mine.~
== BSKIE ~Really? You're such a good friend.~
== X3RecB ~You could learn to make your own. There are a few good guides you could find, in the right library.~
== BSKIE ~That sounds like too much work. I'm happy with this for now.~
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("X3RecTiax","GLOBAL",0)~ THEN BTIAX X3RecTiax1
...
== BTIAX ~Tiax shall forgive you this once for declining before he spoke!~
...
== BTIAX ~You refuse me twice! Tiax will not forget this.~
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("X3RecViconia","GLOBAL",0)~ THEN BVICON X3RecViconia1
~Surface music is so...irritating.~
DO ~SetGlobal("X3RecViconia","GLOBAL",1)~
== X3RecB ~What was your songs and dance like below?~
== BVICON ~I do not think you would want to know, diminutive one. Pleasant sounds are not useful, unless you intended to seduce for a kill.~
== X3RecB ~Was there no thoughts of fun, or bonding, or joy?~
== BVICON ~For a bard who loves books and knowledge you know so little of my world.~
...
== BVICON ~I don't. And don't think of bothering me for answers later.~ 
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("X3RecXan","GLOBAL",0)~ THEN BXANNN X3RecXan1
...
== BXANNN ~And if they become bawdy tavern songs?~
== X3RecB ~I um...how would that even happen?~
== BXANNN ~What is kept is determined by the original listener. They may spin and spread it in a less clean way.~
...
CombatCounter(0)
!See([ENEMY])
Global("X3RecXzar","GLOBAL",0)~ THEN BXZAR X3RecXzar1
...
== BXZAR ~No, no. Something more upbeat. Menacing. Something to terrify our enemies to the bone.~
== X3RecB ~Why would I play something so horrible?~
== BXZAR ~I want them to know of their impending suffering.~
...
CombatCounter(0)
!See([ENEMY])
Global("X3RecYeslick","GLOBAL",0)~ THEN BYESLI X3RecYeslick1
...
== BYESLI ~Fruitless, lass? Yer music be an inspiration, and good for our morale.~
...
== BYESLI ~I be aware of many marvels from that place, including air ships. But there always be a place for simple, soothing art. That be the secret to peace.~
== X3RecB ~Music, and the preservation of knowledge. Those too, are my beliefs to long-lasting peace.~
== BYESLI ~A pity it be easier thought than done.~
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("X3RecAlora","GLOBAL",1)~ THEN BALORA X3RecAlora2
...
== BALORA ~Oh, I have it. I was so excited I forgot to ask first, but then I asked.~
...
== BALORA ~*Puff* It's not making any noise.~ 
...
== BALORA ~Okay...I got it! *puff puff puff*.~
...
== BDynah ~Thy asks a broad question. Does thee wish to know of the land, the sprawling lakes, rivers, forests and mountains?~
...
== BDynah ~Some secrets are best kept that way. Thee vile red wizards would pillage all of my home's magical mysteries if thee could.~
== X3RecB ~I understand. But perhaps, just a small story sometime?~
== BDynah ~Perhaps, child. But not now. 'Tis not the time.~ 
EXIT 
...
CombatCounter(0)
!See([ENEMY]) 
Global("X3RecFaldorn","GLOBAL",1)~ THEN BFALDO X3RecFaldorn2
~I may have judged you wrongly, gnome.~
DO ~SetGlobal("X3RecEldoth","GLOBAL",2)~
== X3RecB ~What do you mean?~
== BFALDO ~Your connection to the ferret is more than just a toy or pet.~
== BFALDO ~There are many times he could have chosen to run free, or leave you, but he has chosen to stay with you. I did not see that before.~
...
== BFALDO ~And I see that now. A pity more do not have such bonds with woodland creatures.~ 
EXIT 
...
== BGARRI ~I prefer my voice and poetry to instruments, but I am trained in the typical bardic instruments.~
...
== BGARRI ~Really? But I found your voice so soothing and lovely.~
...
== BGARRI ~There is no need to be afraid. Perhaps we can perform together in a tavern someday?~
...
== BIMOEN ~I'm dance walking..~
== X3RecB ~Is this a safe time to be doing that?~
== BIMOEN ~Maybe not, but you could show me one of your moves real quick.~
== X3RecB ~Um, well...maybe try a bit of a spin, like this, and then a one step, two step, one back like this.~
== BIMOEN ~Hey, I look so graceful doing this.~
== X3RecB ~You've got it down to a pat. I think you're better at dancing than me.~
== BIMOEN ~Heh, I don't know about that. But we better stop our weird dance walk before <CHARNAME> gets grouchy at us.~ 
EXIT 
...
== BJAHEI ~To transform into a creature of the wild? Your senses are much like the creature, though my mind is completely my own.~
== X3RecB ~Are there any other differences you feel? Is it painful?~
== BJAHEI ~There is no pain to speak of, though I do feel different. No longer human.~
== X3RecB ~It sounds amazing. I wish I could use a spell like that.~
== BJAHEI ~It is a tool to use wisely, and not something to play with. But perhaps your youthful enthusiasm is not out of place. It is a wonderful thing to feel.~
EXIT 
...
== BKHALI ~I am a little n-nervous sometimes. But I am able to d-do what is necessary.~
== X3RecB ~I admire your strength, Khalid. I wish I had the same courage.~
== BKHALI ~T-thank you, Recorder. Thank you.~
EXIT
...
== BMINSC ~It is as Minsc said. All will be well.~
...
== BMINSC ~Ah, but you can. You must only listen to their cry, their little movements, and watch their adorable eyes.~
...
== BQUAYL ~So that others could benefit from my vast intelligence?~
== X3RecB ~Yes. You could share all of that knowledge to the next generation. It ensures that everyone is prepared.~
== BQUAYL ~That is a very smart idea. Although I doubt their craniums could comprehend much of what I say.~
== X3RecB ~Maybe. Maybe not. But you would be doing something really good for them, if they even grasped a little bit.~
== BQUAYL ~I'll consider this. Perhaps some youthful person could benefit well from me.~
EXIT
...
== BRASAAD ~Of course Recorder. Please, share what ails you.~
...
== BRASAAD ~You blame yourself for his passing?~
== X3RecB ~We were supposed to keep each other safe.~
== BRASAAD ~Failings help us rise up stronger, Recorder. Though I understand why you feel the shame.~
== X3RecB ~Does it ever get easier? This feeling?~
== BRASAAD ~It does. But it takes time, and healing. And I will be here to help.~
...
== BSkie ~Is that a rose? What is this for?~
== X3RecB ~Perfume! I'm doing it by memory, but I have everything we need.~ 
== BSkie ~How exciting! I definitely want that. What's next?~
== X3RecB ~It's just a bit of extracting of that scent into an oil, and a lot of waiting.~
== BSKIe ~Waiting? How long are we talking about?~
== X3RecB ~A few weeks? Maybe a month or so?~
== BSKIE ~We don't have that kind of time, Recorder. Thanks, but I'm happy with what you gave me.~
== X3RecB ~Just have a little patience. I promise it will be worth it.~
== BSKIE ~All right, all right. I can't wait to show this off once it's ready.~
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("X3RecTiax","GLOBAL",1)~ THEN BTIAX X3RecTiax2
~Tiax wishes to revisit his proposal with Recorder~ 
DO ~SetGlobal("X3RecTiax","GLOBAL",2)~
== X3RecB ~Tiax...no means no.~
== BTIAX ~Why do you refuse Tiax? Tiax will soon rule all before him. An opportunity most would jump for.~
...
== BTIAX ~Madness! Tiax finds the gnome woman most frustrating.~
EXIT
...
== BXANNN ~We delay the inevitable doom.~
== X3RecB ~Um...maybe a bit more detailed the that?~
== BXANNN ~I glean information from where I am told to go and inform my superiors on how dreary things are..~
== X3RecB ~So you are like guardians. It seems a noble cause.~
== BXANNN ~Noble and very solemn, as all things can be.~
== X3RecB ~Thank you. That's something I can jot down in my records.~
== BXANNN ~If you live to tell the tale.~
EXIT
...
== BYESLI ~Aye. It was once the pride of my clan, before it was turned into what it was.~
== X3RecB ~If I recall, it supplied much of the metal materials for the entire region.~
== BYESLI ~Aye it did. A pity the mistakes that were made saw the end of that.~
== X3RecB ~I'm being insensitive. I don't mean to bring back bad memories.~
== BYESLI ~Nay lass, ye be all right. I just wish the chance to make them right again, and I will.~
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("X3RecAlora","GLOBAL",2)~ THEN BALORA X3RecAlora3
...
== BIMOEN ~You mean that little bit of shimmy? I thought it might catch them off guard.~
== X3RecB ~It makes it a bit easier to deal with.~
== BIMOEN ~You mean all the hurting? Sure, yep. A bit of a bright spot, isn't it?~
...
== BMINSC ~Ah, you wish to learn the speech of Boo and the forest?~
== X3RecB ~I may have never read how in any text, but if you know then surely I can.~
== BMINSC ~Minsc will be glad! First ah...hrm. Put your ear close to Boo? What do you hear?~
== X3RecB ~Um, not much of anything, really. Maybe we can try speaking first?~
== BMINSC ~Ah, say something to Boo! He will listen.~
== X3RecB ~Hi Boo. You look adorable!~
== BMINSC ~Ah, Boo is most flattered by your compliment.~
== X3RecB ~Really? They understand us just like that?~
== BMINSC ~Of course! Boo is an intelligent miniature giant space hamster!~
...
== BQUAYL ~Music is beneath my intelligent interests.~
...
== BQUAYL ~So there is a need for me? Masses of people trying to grasp a portion of my knowledge.~
...
== BSkie ~Wow, really? That was faster than I thought it would take.~
== X3RecB ~We do travel for quite a bit of time. Doesn't it smell lovely? I think you chose the floral components well.~ 
== BSkie ~Oh neat, I can't wait to use it. Thank you, Recorder.~
== X3RecB ~Hee, I'm happy to have done this.~
== BSKie IF ~IsValidForPartyDialogue("Eldoth")~ THEN ~What do you think Eldoth? How does it smell?~
== BELDOT IF ~IsValidForPartyDialogue("Eldoth")~ THEN ~Get it away from my nose. It stings!~
== BSKIE IF ~IsValidForPartyDialogue("Eldoth")~ THEN~Sorry, Recorder. I don't want to offend Eldoth's senses.~
...
CombatCounter(0)
!See([ENEMY])
Global("X3RecTiax","GLOBAL",2)~ THEN BTIAX X3RecTiax3
...
== BTIAX ~There is no spot higher, no greater position that Tiax could bestow that is nearly equal..than as Tiax's wife.~
== X3RecB ~What?!~
== BTIAX ~Beneath us all you will see people bowing to us, but mostly to me and my lord. I have convened with him, and he is fine with you serving him as well.~
== X3RecB ~Oghma, please save me...~
== BTIAX ~You walk away? You have not given Tiax an answer! You insult Tiax so! So he revokes his offer, and you will regret your chance you had when I rule all.~
EXIT
...
== BXANNN ~The worse is certain, given our path.~
== X3RecB ~If something happens to me, could you take my records to the church of Oghma in Candlekeep or Amn?~
== BXANNN ~You are using me as the distributor of your knowledge in your passing? I refuse this dreary task!~
== X3RecB ~Um, but why? I thought you might be understanding.~
== BXANNN ~Doomed as we all are, you are our knowledge holder. Our doom needs a record keeper.~
== X3RecB ~If this is your odd way of um, saying you wish me safe, thank you?~
== BXANNN ~I will try. But danger will come to us.~
...
== BIMOEN ~Nah. I'll miss Winthrop and some of the others, but <CHARNAME> is like family to me. He's all I have now.~
...
== BIMOEN ~Sounds like you'd love to go back.~
...
CombatCounter(0)
!See([ENEMY])
Global("X3RecQuayle","GLOBAL",3)~ THEN BQUAYL X3RecQuayle4
...
== BQUAYL ~And watch the majority utterly fail my tests and challenges? No. Not at all.~
== X3RecB ~Oh, well...~
== BQUAYL ~Instead, I will designate one pupil who is capable of comprehending my knowledge to teach and pass on what I've learned..~
