...
== X3RecJ IF ~InParty("X3Rec") InMyArea("X3Rec") !StateCheck("X3Rec",CD_STATE_NOTVALID)~ THEN ~Thank you for doing all that you do, miss Gellana.~
...
+~GlobalGT("X3RecorderApproval","GLOBAL",69)Global("X3RecSpecial","GLOBAL",0)~+ ~Is there anyone special in your life?~ DO ~SetGlobal("X3RecSpecial","GLOBAL",1)~ + RecP.Special // Also in SoD, Approval Based.  
